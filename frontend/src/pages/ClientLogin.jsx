          ...
          <div className="grid lg:grid-cols-[1fr_1.05fr] gap-14 lg:gap-24 items-center">
            ...
            <section>
              ...
              <p className="mt-8 max-w-lg text-gray-400 text-sm sm:text-base leading-7">
                ...
                Tell us a little about yourself and become part
                of the Ink Convention 2026 experience. Your details
                help us connect you with the right people, events
                and opportunities.
                    ...
                    >
                      ...
                      <div className="flex items-start gap-2.5 pt-1">
                        ...
                        <p className="font-mono text-[8px] leading-4 text-gray-600 uppercase tracking-wider">
                          ...
                          Your information is collected solely for
                          Ink Convention communication and event-related
                          purposes.
